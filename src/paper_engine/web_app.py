...
class WebApp:
    ...
    def _job_state_dir(self) -> Path | None:
        if self.topic_root:
            return None
        if self.base_dir:
            return self.base_dir / ".paper_engine_serverlet"
        return None
    ...
    def _maybe_bind_bootstrap_topic(self) -> Path | None:
        ...
        summary_path = self.base_dir / ".paper_engine_serverlet" / "jobs" / job_id / "summary.json"
    ...
    def _bootstrap_init_action(self, body: str) -> WebResponse:
        ...
        manager = JobManager(
            ...
            state_dir=self.base_dir / ".paper_engine_serverlet",
