...
def main() -> int:
    parser = argparse.ArgumentParser(description="Collect a batch of exact paper titles using battery_lit collect.")
    ...
    parser.add_argument("--battery-paper", default=os.environ.get("BATTERY_LIT_BIN", "battery_lit"))
    ...
    dedup = _run([args.battery_lit, "tool", "dedup", "--root", args.root, "--fix", "--json"])
    summary = {
