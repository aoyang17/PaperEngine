...
- `paper_engine candidates list --json --status new --sort score --min-score 0`
- `paper_engine candidates list --json --status relevant`
- `paper_engine candidates list --json --status irrelevant`
...
4. Apply labels with `paper_engine candidates mark` or `paper_engine candidates dismiss`.
